...
public class get_str_dest extends AppCompatActivity {
    EditText start;
    EditText dest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_str_dest);
...
//                editor.apply();
                    Intent mint=new Intent(get_str_dest.this,Route_Finding.class);
                    mint.putExtra("start",start_address);
                    mint.putExtra("dest",dest_address);
                    get_str_dest.this.startActivity(mint);
                }
                catch (Exception ex)
                {
